import { filterTextBySection, statisticsList } from '@/types/constants'
import { SectionText } from '../../../section-text/Index'
import { Divider } from '@chakra-ui/react'

export const Statistics = () => {
  return (
    <section className="bg-gray_light py-20">
          ...
          {statisticsList.map((statistic, index) => {
            return (
              ...
              >
                ...
                <div>
                  <p className="text-2xl font-semibold">{statistic.name}</p>
